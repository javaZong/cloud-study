package com.cloud.study.nio.mutli;

import com.cloud.study.nio.ByteBufferStudy;
 ...
 * @author zongchao
 */
public class NioStudyChatMutliServer {
    private Selector selector;
    private ServerSocketChannel serverSocketChannel;
    public static final int PORT = 6667;
    private Worker worker;

    public NioStudyChatMutliServer() {
     ...
     * 监听接收客户端消息，并转发到其他客户端
     */
    public void listenClientAccept() {
        try {
            do {
                // 获取监听的事件总数
    ...
    public static void main(String[] args) throws Exception {
        NioStudyChatMutliServer chatServer = new NioStudyChatMutliServer();
        //启动服务器，监听
        chatServer.listenClientAccept();
    }
    ...
    static class Worker implements Runnable {
        ...
        public void register(SocketChannel socketChannel) throws IOException {
            ...
            selector.wakeup();
            System.out.println(socketChannel.getRemoteAddress() + "上线前");
